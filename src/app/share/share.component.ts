...
export class ShareComponent implements OnInit {
  ...
  params = {
    ...
    twitter: {
      ...
      msg: encodeURIComponent('Hello Victor est une assurance 100% mobile qui couvre tous vos objets #insurtech')
    },
    gplus: {
      url: encodeURIComponent('https://goo.gl/ZixcFo')
    },
    mail: {
      subject: encodeURIComponent('Hello Victor, l\'assurance 100% mobile'),
      body: encodeURIComponent(`Hello,
    
J’ai pensé qu’Hello Victor http://hellovictor.fr pourrait t’intéresser. C’est une assurance 100% mobile qui couvre tes objets (ex: enceintes, guitares, vélo, smartphone ...), bref tes biens, ton appart. 
